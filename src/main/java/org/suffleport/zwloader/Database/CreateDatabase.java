...
public class CreateDatabase {
    ...
    private void insertInitialData(Statement st) throws SQLException {

        st.execute("INSERT INTO roles (role_id, name) VALUES (0, 'USER') ON CONFLICT (role_id) DO NOTHING");
        st.execute("INSERT INTO roles (role_id, name) VALUES (1, 'ADMIN') ON CONFLICT (role_id) DO NOTHING");


        String hashedPassword = passwordEncoder.encode("admin123");
        String sql = "INSERT INTO shuffleport_users (email, password, role_id) VALUES ('admin@zwloader.com', '" + hashedPassword + "', 1) ON CONFLICT (email) DO NOTHING";
        st.execute(sql);
    }
}
